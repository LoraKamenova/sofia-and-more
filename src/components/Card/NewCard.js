    ...
    return (
        <article className="new-card">
            <div className="new-card-image-wrapper">
                <img className="new-card-image" src={props.url} alt=""/>
            </div>
            <div className="new-card-content-wrapper">
                ...
                <div className="new-card-text-wrapper">
                    <h3 className="new-card-text">{props.content}</h3>
                </div>
                <div className="new-card-button-wrapper">
                    <div className="new-card-fake-button">Прочети<i class="fa fa-angle-double-right"></i></div>
                </div>
            </div>
        </article>
    );
